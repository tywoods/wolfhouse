...
**Status:** IN PROGRESS (2026-06-01) — 7.0–7.6 planning DONE · 7.2b migration 009 DONE · 7.2c auth middleware DONE · 7.3b Azure IaC scaffold DONE · 7.7a–d DONE · 7.7f handoff queue integration DONE · 7.7g bed calendar query/API DONE · 7.7h bed calendar read-only render DONE · 7.7i booking detail drawer DONE · 7.7j copy/review shadow workflow DONE · **7.7k safe bed reassignment plan DONE (design only)** · **7.3c preflight PASS** · **7.3d Azure staging deployed + login proven (2026-06-01): Staff API live, n8n live, Ty owner login confirmed, 11 workflows imported inactive, all safety flags confirmed, DNS/custom TLS not yet configured**. No reassignment write implemented; no pilot approved; live operation NOT approved.
...
| 7.3 | Staging deployment plan | HTTPS, domain, deploy target, reproducible from `infra/`; staging stands up with workflows inactive | **DONE (design + deployed)** — [`PHASE-7.3-STAGING-DEPLOYMENT-TLS-PLAN.md`](PHASE-7.3-STAGING-DEPLOYMENT-TLS-PLAN.md) · 7.3b IaC scaffold PASS · 7.3c preflight PASS · **7.3d Azure staging deployed + login proven (2026-06-01)** |
...
| **7.3** | Staging deployment + TLS | **DESIGN DONE · 7.3b IaC scaffold PASS · 7.3c preflight PASS · 7.3d DEPLOYED + LOGIN PROVEN (2026-06-01)** | [`PHASE-7.3-STAGING-DEPLOYMENT-TLS-PLAN.md`](PHASE-7.3-STAGING-DEPLOYMENT-TLS-PLAN.md) | DNS/custom domain not configured; custom TLS on lunafrontdesk.com not active; real login page not built; 3 workflows not yet imported; backup/monitoring not wired | Gates C1–C9 in 7.6 |
...
| **7.7** | Cami review dashboard + editable bed calendar | **IN PROGRESS** | [`PHASE-7.7-CAMI-REVIEW-DASHBOARD-PLAN.md`](PHASE-7.7-CAMI-REVIEW-DASHBOARD-PLAN.md) | 7.7a–d + **7.7f DONE**: plan + API + inbox UI + thread/draft/context panel + **handoff queue (Needs Human sub-tab)**; bed calendar still pending | Gates F1–F8 in 7.6 (bed calendar = hard requirement) |
