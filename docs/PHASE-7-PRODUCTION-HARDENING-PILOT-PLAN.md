...
**Status:** IN PROGRESS (2026-06-01) — 7.0–7.6 planning DONE · 7.2b migration 009 DONE · 7.2c auth middleware DONE · 7.3b Azure IaC scaffold DONE · 7.7a–d DONE · 7.7f handoff queue integration DONE · 7.7g bed calendar query/API DONE · 7.7h bed calendar read-only render DONE · 7.7i booking detail drawer DONE · **7.7j copy/review shadow workflow DONE**. No pilot approved; live operation NOT approved.
