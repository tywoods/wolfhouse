...
| **8** Client-ready staging | **PLANNING — 8.0 roadmap DONE (2026-06-02)** | [STAGE-8-CLIENT-READY-STAGING-ROADMAP.md](STAGE-8-CLIENT-READY-STAGING-ROADMAP.md). Turn the hosted Azure staging prototype into a polished, show-ready Luna Front Desk shadow-mode demo for Ale/Cami while keeping all live gates closed. 8 pillars (UI polish · staff experience · demo data · Cami workflow · manual-booking roadmap · safety/ops gates · DNS polish · multi-client awareness); slices 8.0–8.13; 14-item ready-to-show checklist. NOT in scope: production launch, live WhatsApp/Stripe, autonomous send, Sunset onboarding, multi-client platform, n8n extraction, production billing. Slices 8.1–8.13 NOT started. Pilot decision NO_GO. | Show-to-client only after §5 checklist passes |
