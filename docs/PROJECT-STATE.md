...
| **7** Scalable | **IN PROGRESS** (2026-06-01) — 7.0–7.7 DESIGN DONE. **7.2b/c DONE** · **7.3b DONE** · **7.7a–d + 7.7f–7.7j DONE** · **7.7k reassignment plan DONE (design)** — **7.7k**: §5a safe bed reassignment design — same-range bed→bed only, 14 hard blockers, in-tx overlap guard, audit + rollback, sub-slices 7.7k1–7.7k8; write NOT implemented; F8 DESIGN_DONE. No Azure. Staging/prod NOT secure. Next: 7.7k1 reassign SQL helper (static) or 7.7o booking edit/write gates plan. Plan: [PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md](PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md). | Multi-client + Azure when approved |
