...
**Last updated:** 2026-05-31 (Stage 5.5 CLOSE WITH DEFERRALS — rooming/bed assignment queries proven; static verifier 56/56; smoke PASS)
...
| **5** Clean | **5.1 PASS. 5.2 CLOSE WITH DEFERRALS. 5.3 CLOSE WITH DEFERRALS. 5.4 CLOSE WITH DEFERRALS. 5.5 CLOSE WITH DEFERRALS (2026-05-31).** Stage 5.5: 6 rooming query helpers (A–F) + static verifier 56/56 + smoke PASS — assigned/unassigned/occupied/arrivals all correct; `booking_beds` 15→16→15 (baseline restored). **Next: Stage 5.6 — add-ons schema stub.** | Targeted SoT cleanup for Wolfhouse pilot readiness. Plan: [PHASE-5-SOURCE-OF-TRUTH-CLEANUP.md](PHASE-5-SOURCE-OF-TRUTH-CLEANUP.md). |
...
**Immediate next step: Stage 5.6 — add-ons schema stub.** Stage 5.5 CLOSE WITH DEFERRALS (2026-05-31): 6 rooming query helpers (A–F) static + smoke PASS; `booking_beds` 15→16→15 baseline; static verifier 56/56; no workflow activation.
