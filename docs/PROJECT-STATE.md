...
| **8** Client-ready staging | **PLANNING — 8.0 roadmap + 8.1 UX cleanup plan DONE (2026-06-02)** | [STAGE-8-CLIENT-READY-STAGING-ROADMAP.md](STAGE-8-CLIENT-READY-STAGING-ROADMAP.md) · [STAGE-8.1-DASHBOARD-UX-CLEANUP-PLAN.md](STAGE-8.1-DASHBOARD-UX-CLEANUP-PLAN.md). Turn the hosted Azure staging prototype into a polished, show-ready Luna Front Desk shadow-mode demo for Ale/Cami while keeping all live gates closed. 8 pillars; slices 8.0–8.13; 14-item ready-to-show checklist. **8.1**: default landing "Today / Needs Attention"; sidebar nav; Query Tools → admin/dev-only; Luna design tokens; bed-calendar/drawer/thread cleanup specs. NOT in scope: production launch, live WhatsApp/Stripe, autonomous send, Sunset onboarding, multi-client platform, n8n extraction, production billing. Slices 8.2–8.13 NOT started. Pilot decision NO_GO. | Show-to-client only after §5 checklist passes |
