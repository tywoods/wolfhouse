...
**Last updated:** 2026-06-01 (**Stage 7.7j — copy/review shadow workflow DONE**. UI: copy confirmation upgraded to "Copied — send manually in WhatsApp"; manual-send instructions line added; shadow-mode workflow checklist (5 steps + live-send gate warning); stage badge → 7.7j. Verifier 28/28 PASS. Proof: fixture conversation +34600000191 → inbox row, messages 1 inbound, draft_available=true with Luna draft text, staff-state needs_human=true; GET /staff/ui passes all 7.7j checks; audit api:conversation.* success=true; delta=0. Pilot checklist F1–F7 updated to IMPLEMENTATION_PROVEN. Prior: 7.7i booking detail drawer. Pilot: NO_GO.)
...
| **7** Scalable | **IN PROGRESS** (2026-06-01) — 7.0–7.7 DESIGN DONE. **7.2b/c DONE** · **7.3b DONE** · **7.7a–d + 7.7f–7.7j DONE** — **7.7j**: shadow-mode checklist; "Copied — send manually in WhatsApp"; draft-instructions; 28-check verifier PASS; proof: inbox + thread + draft_available + audit; pilot checklist F1–F7 IMPLEMENTATION_PROVEN. No Azure. Staging/prod NOT secure. Next: 7.7k safe bed reassignment plan. Plan: [PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md](PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md). | Multi-client + Azure when approved |
