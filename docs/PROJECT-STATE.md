...
**Last updated:** 2026-05-31 (**Stage 6.5b DONE** — confirmed staff action write gate; `handoff.resolve --confirm` executes UPDATE; idempotency no-op proven; staff_handoffs + protected tables Δ=0)
**HEAD (expected):** `04d119b` → pending commit (Stage 6.5b)
