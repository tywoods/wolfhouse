...
| **4** Reliable | **Autonomous Booking Dry-Run - A1–A10 + A9 PASS (2026-05-30)** | A1 full booking dry-run PASS. A5 closed-month guard PASS. A6/A7/A8/A10 PASS. A2/A3/A4 multi-turn PASS (PG shared-path + BSR 2f.9). **A9 add-ons PASS:** T1 exec 1206 route=general_question conf=0.95, reply quotes €65 for 2 surf lessons (tiered €35+€30 from config); T2 exec 1205 route=general_question, yoga €15/class on-site, no payment link. service_addons prompt injection PROVEN. Protected counts Δ=0. **Next: Italian multilingual batch or Stage 4 closeout planning.** |
