...
| **8** Client-ready staging | **IN PROGRESS — 8.0/8.1/8.2/8.5/8.6 DONE (2026-06-02)**. 8.6: 18 demo rows seeded to Azure staging (3 convs, 7 msgs, 3 bookings, 2 booking_beds, 1 handoff, 2 payments + 2 demo rooms + 4 demo beds); proof 28/28 PASS; `STAFF_ACTIONS_ENABLED=false`, `WHATSAPP_DRY_RUN=true` confirmed; demo data intentionally retained for Ale/Cami. | [STAGE-8-CLIENT-READY-STAGING-ROADMAP.md](STAGE-8-CLIENT-READY-STAGING-ROADMAP.md) · [STAGE-8.5-DEMO-DATA-SEED-PLAN.md](STAGE-8.5-DEMO-DATA-SEED-PLAN.md). Next: 8.3 bed calendar cleanup or 8.8 Cami/Ale accounts. Pilot NO_GO. | Show-to-client only after §5 checklist passes |
