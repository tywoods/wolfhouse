...
**Last updated:** 2026-05-31 (**Stage 5.9 PASS** — migrations 007+008 applied to local/dev DB; fixture smoke 26/26 green; `getNeedsHumanWithoutOpenHandoffQuery()` `hostel_id` bugfix applied)
