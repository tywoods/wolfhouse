...
| **7** Scalable | **PLANNING** (2026-05-31) — 7.0 plan DONE · 7.1 env/secrets inventory DONE · **7.2 auth/staff-accounts design DONE** (email/password + session cookies for pilot; viewer/operator/admin matrix; migration 009 designed not created; go/no-go blocks). No implementation; live ops NOT approved. Plan: [PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md](PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md) · Auth: [PHASE-7.2-AUTH-STAFF-ACCOUNTS-PLAN.md](PHASE-7.2-AUTH-STAFF-ACCOUNTS-PLAN.md). | Multi-client + Azure when approved |
