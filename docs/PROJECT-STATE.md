...
| **8** Client-ready staging | **IN PROGRESS — 8.0/8.1/8.2/8.5 DONE (2026-06-02)**. 8.2: Azure rev `0000004`, Today view, Inbox tab, Developer Tools. 8.5: demo data seed plan; 3 scenarios (Sofia/needs-human, Marco/payment-pending, Lena/confirmed+bed-calendar Jul 16–22); 18 rows across 6 tables; JS seed+cleanup+proof planned. Data not yet seeded. | [STAGE-8-CLIENT-READY-STAGING-ROADMAP.md](STAGE-8-CLIENT-READY-STAGING-ROADMAP.md) · [STAGE-8.5-DEMO-DATA-SEED-PLAN.md](STAGE-8.5-DEMO-DATA-SEED-PLAN.md). Next: Stage 8.6 seed implementation. Pilot NO_GO. | Show-to-client only after §5 checklist passes |
