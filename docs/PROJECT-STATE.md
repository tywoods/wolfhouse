...
| **7** Scalable | **IN PROGRESS** (2026-06-02) — 7.0–7.7 DESIGN DONE. **7.2b/c DONE** · **7.3b DONE** · **7.3c PREFLIGHT PASS** · **7.3d AZURE STAGING DEPLOYED + LOGIN PROVEN (2026-06-01)** · **7.3e LOGIN PAGE + AZURE PROOF + LOGOUT FIX + COMPANY WORDING (2026-06-02)** · **7.7a–d + 7.7f–7.7j DONE** · **7.7k1–k8 DONE**. **7.3e-fix (2026-06-02)**: logout root cause = `doLogout` trapped in IIFE; fixed via `window.doLogout`; "Client" → "Company" UI labels; image `wh-staff-api:6fcf6ab`; revision `0000003`; all verifiers PASS. DNS/custom domain not configured. Calendar editing NOT approved. Next: Stage 7.3f (DNS/custom domain). Plan: [PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md](PHASE-7-PRODUCTION-HARDENING-PILOT-PLAN.md). | Multi-client + Azure when approved |
