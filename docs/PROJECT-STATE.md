...
| **8** Client-ready staging | **IN PROGRESS — 8.0 roadmap + 8.1 UX plan + 8.2 visual polish DONE (2026-06-02)**. Azure rev `0000004` (`wh-staff-api:74eed37-8x2`). Today/Needs Attention default view; Inbox tab; Developer Tools admin-only; natural room sort; 59 conv checks + 43 bed-cal checks all green. | [STAGE-8-CLIENT-READY-STAGING-ROADMAP.md](STAGE-8-CLIENT-READY-STAGING-ROADMAP.md) · [STAGE-8.1-DASHBOARD-UX-CLEANUP-PLAN.md](STAGE-8.1-DASHBOARD-UX-CLEANUP-PLAN.md). Slices 8.3–8.13 not started. Pilot NO_GO. | Show-to-client only after §5 checklist passes |
