...
**Last updated:** 2026-06-02 (**Stage 8.3s DONE** — Batch Azure deploy for 8.3l+8.3q+8.3r. Image: wh-staff-api:1894036-8x3s-batch. Revision: wh-staging-staff-api--0000012 (100% traffic, Healthy, Write actions DISABLED). Smoke: /staff/login 200, auth-guard redirects unauthenticated /staff/ui, STAGING/SHADOW MODE badge visible. Safety flags: STAFF_ACTIONS_ENABLED=false, MANUAL_BOOKING_ENABLED absent/false, WHATSAPP_DRY_RUN=true, n8n untouched. No DB writes. No operator blocks. No room releases.)
