...
| **10** Staff Operations Polish | **IN PROGRESS — 10.0a PASS** | Bed Calendar nights fix hosted; turnover layering PARTIAL (no staging fixture). **Next: 10.1** manual booking polish |
