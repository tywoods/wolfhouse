**8.7.23 BED CALENDAR RANGE + SELECTED STAY POLISH -- PASS (2026-06-03):** UI-only — removed Bed Calendar Today range chip; kept This week / Next 30 days / Jul–Aug; auto-load Next 30 days unchanged. Selected Stay section left-aligned via `.bk-compact-grid` (matches Guest/Payment/Add-ons). `verify-staff-bed-calendar-ui.js` PASS (+10). No backend/n8n/WhatsApp/Stripe/Azure. **Not deployed.**
