**8.7.8 BED CALENDAR LOAD + SELECTION UX -- PASS (2026-06-03):** Auto-load Next 30 days on first Bed Calendar tab open; booking click clears manual booking panel; selected empty cells toggle off. `verify-staff-bed-calendar-ui.js` 312/312 PASS. No backend/n8n/WhatsApp/Stripe/Azure. Redeploy Staff API to apply on staging.
