...
| Rooming / reassign E2E | **Pending** | **3e.1** inventory done — [`PHASE-3e-ROOMING-REASSIGN-PLAN.md`](PHASE-3e-ROOMING-REASSIGN-PLAN.md); **3e.2** remap hosted `reassign-booking-beds` URL |
