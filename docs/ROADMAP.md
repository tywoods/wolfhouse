...
| **10** Staff Operations Polish | **IN PROGRESS — 10.0 + 10.1 COMPLETE ENOUGH / PASS** | **10.0** Bed Calendar nights + turnover + form nights (`625b766` / `--0000050`). **10.1** manual booking create UX polish (`c06b486` / `--0000051`; proof `MB-WOLFHO-20260920-4f62e2`). **Next: 10.2** move room/bed preview (preview-only) |
