...
| **10** Staff Operations Polish | **IN PROGRESS — 10.0–10.4 PASS (2026-06-04)** | **10.0–10.2** preview · **10.3** move write · **10.3e** drawer move UI · **10.4** date-change preview hosted (`ac4c1d5` / `--0000061`). **Next:** **10.4e** preview UI **or** **10.5** write spec (recommend **10.4e**) |
