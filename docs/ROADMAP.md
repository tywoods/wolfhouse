...
| **10** Staff Operations Polish | **IN PROGRESS — 10.0–10.4 PASS; 10.3 bed-move CLOSED (2026-06-04)** | **10.0–10.2** preview · **10.3** single-bed + **10.3e–10.3i** multi-bed move (hosted **`636aac2`**) · **10.4** date-change preview API. **Next:** **10.4e** date-change preview UI (preview-only). |
