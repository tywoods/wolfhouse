...
| **10** Staff Operations Polish | **IN PROGRESS — 10.0–10.4b PASS; 10.3 bed-move CLOSED; 10.4c spec PASS** | **10.0–10.2** preview · **10.3** move (**`636aac2`**) · **10.4** date-change preview API · **10.4c** field-edit + running invoice spec. **Next:** **10.4d** invoice display → **10.4e** edit UI shell → **10.4f** preview API → **10.5** gated writes → **10.6** add-ons UI. Spec: [PHASE-10.4-FIELD-EDIT-RUNNING-INVOICE-SPEC.md](PHASE-10.4-FIELD-EDIT-RUNNING-INVOICE-SPEC.md). |
| **11** Guest Luna Booking Dry-Run | Full guest booking path dry-run (not live) |
| **12** Wolfhouse Pilot Readiness | Go/no-go, demo hardening |
| **13** Controlled Wolfhouse Pilot | Limited live pilot (Ty-approved) |
| **14** Tour Operator & Housekeeping Ops | Operator block/release, housekeeping |
