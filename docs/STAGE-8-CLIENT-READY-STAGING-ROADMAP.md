...
**Status:** IN PROGRESS — 8.0 roadmap DONE, 8.1 UX plan DONE, 8.2 visual polish DONE, 8.5 demo data plan DONE, 8.6 demo data seeded DONE, 8.3 operations plan DONE, **8.3a bed calendar read-only cleanup DONE (2026-06-02)**. Slices 8.3b–8.3o (impl), 8.4, 8.7–8.13 not started.
...
| **8.3b–8.3o** | Bed calendar operations sub-slices | code/docs | Per STAGE-8.3 §9 ladder. 8.3b (drawer cleanup) required before Ale/Cami demo; 8.3e+ gated writes toward spreadsheet replacement (not demo-required). |
