...
**Status:** IN PROGRESS — 8.0+8.1+8.2+8.5+8.6+8.3 plan+8.3a+**8.3b DONE (2026-06-02)**. Slices 8.3c–8.3o, 8.4, 8.7–8.13 not started.
...
| **8.3c–8.3o** | Bed calendar operations sub-slices | code/docs | Per STAGE-8.3 §9 ladder. 8.3e+ gated writes toward spreadsheet replacement (not demo-required). |
