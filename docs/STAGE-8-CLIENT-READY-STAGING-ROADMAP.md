...
| **8.3b** | Booking detail drawer cleanup | code | **DONE (2026-06-02)** — 6 named sections (Guest/Stay/Room-Beds/Payment/Add-ons/Conv-Handoff), nights badge, Total/Paid/Remaining balance rows, planned-actions disabled stub, no raw UUIDs. Verifier 72/72 PASS. Azure proof pending. |
