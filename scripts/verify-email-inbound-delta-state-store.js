...
async function main() {
  ...
  assert.equal(validateMessagesDeltaCursorUrl(
    `https://graph.microsoft.com/v1.0/users/${MAILBOX}/mailFolders/inbox/messages/delta?$skiptoken=x`,
    bindNext,
  ).ok, false, 'reject initial-request path spelling as a continuation');
