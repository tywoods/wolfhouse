...
// ── Behavioral: Escape closes + unlock restores overflow + stacking ────────
{
  ...
  assert.strictEqual(backdrop.style.display, 'none', 'Reservas path close hides backdrop');
  assert.strictEqual(backdrop.getAttribute('hidden'), '', 'Reservas path close sets hidden attr');
}
