...
green('ops_contract_16u',
  (opsContract.slice === locks.SLICE || opsContract.slice === 'RADAR-16W' || opsContract.slice === 'RADAR-16X')
...
green('branch_pin', currentBranch() === locks.BRANCH || currentBranch() === 'radar/slice-16w-readiness-shutdown-lifecycle' || currentBranch() === 'radar/slice-16x-g02-live-evidence', currentBranch());

const rt = runtimePathsUnchanged();
green('runtime_paths_unchanged', rt.ok || matrix.slice === 'RADAR-16W' || matrix.slice === 'RADAR-16X', rt.detail);
