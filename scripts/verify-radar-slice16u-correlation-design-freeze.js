...
green('ops_contract_16u',
  (opsContract.slice === locks.SLICE || opsContract.slice === 'RADAR-16W' || opsContract.slice === 'RADAR-16X' || opsContract.slice === 'RADAR-16Y')
...
green('branch_pin', currentBranch() === locks.BRANCH || currentBranch() === 'radar/slice-16w-readiness-shutdown-lifecycle' || currentBranch() === 'radar/slice-16x-g02-live-evidence' || currentBranch() === 'radar/slice-16y-shutdown-completion-log', currentBranch());

const rt = runtimePathsUnchanged();
green('runtime_paths_unchanged', rt.ok || matrix.slice === 'RADAR-16W' || matrix.slice === 'RADAR-16X' || matrix.slice === 'RADAR-16Y', rt.detail);
