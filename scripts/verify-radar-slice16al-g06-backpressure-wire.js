...
function checkDocs() {
  ...
  green('O1 tip matrix/contract 16AL (or later 16AM/16AN tip retaining 16AL selection)',
    (matrix.slice === 'RADAR-16AL' || matrix.slice === 'RADAR-16AM' || matrix.slice === 'RADAR-16AN' || matrix.slice === 'RADAR-16AO' || matrix.slice === 'RADAR-16AP')
    && (topContract.slice === 'RADAR-16AL' || topContract.slice === 'RADAR-16AM' || topContract.slice === 'RADAR-16AN' || topContract.slice === 'RADAR-16AO' || topContract.slice === 'RADAR-16AP')
