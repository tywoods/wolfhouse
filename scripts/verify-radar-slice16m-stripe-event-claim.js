...
// Successor slices may own HEAD while 16M source remains frozen on its master basis.
const allowedBranches16m = new Set([
  BRANCH,
  'radar/slice-16n-request-completion-log',
]);
ok('C2 HEAD branch matches (16M or successor 16N)', allowedBranches16m.has(branch), `head=${branch}`);
