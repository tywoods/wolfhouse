...
ok('F48 gate-matrix branch pin equals 16AH tip contract + HEAD (16AG lock retained)',
  matrix.branch === BRANCH_16AH
  && contract.branch === BRANCH_16AH
  && slice16ahContract.branch === BRANCH_16AH
  && headBranch === BRANCH_16AH
