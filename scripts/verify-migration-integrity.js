...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 65,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 13);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-65-forward-canonical-lf-v1', forwardVerified === 65, `verified=${forwardVerified}`);
