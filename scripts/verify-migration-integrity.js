...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 82,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 32);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-82-forward-canonical-lf-v1', forwardVerified === 82, `verified=${forwardVerified}`);
