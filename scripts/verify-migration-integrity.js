...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 60,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 8);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-60-forward-canonical-lf-v1', forwardVerified === 60, `verified=${forwardVerified}`);
