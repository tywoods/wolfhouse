...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 68,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 16);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-68-forward-canonical-lf-v1', forwardVerified === 68, `verified=${forwardVerified}`);
