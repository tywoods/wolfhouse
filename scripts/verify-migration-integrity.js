...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 83,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 33);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-83-forward-canonical-lf-v1', forwardVerified === 83, `verified=${forwardVerified}`);
