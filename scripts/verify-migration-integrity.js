...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 66,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 14);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-66-forward-canonical-lf-v1', forwardVerified === 66, `verified=${forwardVerified}`);
