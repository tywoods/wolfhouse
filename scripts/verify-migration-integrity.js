...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 63,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 11);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-63-forward-canonical-lf-v1', forwardVerified === 63, `verified=${forwardVerified}`);
