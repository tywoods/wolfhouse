...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 72,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 20);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-72-forward-canonical-lf-v1', forwardVerified === 72, `verified=${forwardVerified}`);
