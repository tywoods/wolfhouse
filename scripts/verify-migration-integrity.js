...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 51,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 2);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-51-forward-canonical-lf-v1', forwardVerified === 51, `verified=${forwardVerified}`);
