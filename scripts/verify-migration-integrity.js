...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 81,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 31);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-81-forward-canonical-lf-v1', forwardVerified === 81, `verified=${forwardVerified}`);
