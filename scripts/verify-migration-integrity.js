...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 73,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 21);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-73-forward-canonical-lf-v1', forwardVerified === 73, `verified=${forwardVerified}`);
