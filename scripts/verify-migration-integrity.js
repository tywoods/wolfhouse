...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 55,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 3);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-55-forward-canonical-lf-v1', forwardVerified === 55, `verified=${forwardVerified}`);
