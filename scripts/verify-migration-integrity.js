...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 75,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 22);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-75-forward-canonical-lf-v1', forwardVerified === 75, `verified=${forwardVerified}`);
