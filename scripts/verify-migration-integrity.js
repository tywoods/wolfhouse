...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 62,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 10);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-62-forward-canonical-lf-v1', forwardVerified === 62, `verified=${forwardVerified}`);
