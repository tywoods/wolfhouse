...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 64,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 12);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-64-forward-canonical-lf-v1', forwardVerified === 64, `verified=${forwardVerified}`);
