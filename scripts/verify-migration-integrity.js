...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 59,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 7);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-59-forward-canonical-lf-v1', forwardVerified === 59, `verified=${forwardVerified}`);
