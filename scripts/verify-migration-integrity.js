...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 69,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 17);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-69-forward-canonical-lf-v1', forwardVerified === 69, `verified=${forwardVerified}`);
