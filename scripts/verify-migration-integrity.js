...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 56,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 4);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-56-forward-canonical-lf-v1', forwardVerified === 56, `verified=${forwardVerified}`);
