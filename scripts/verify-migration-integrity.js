...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 78,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 23);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-78-forward-canonical-lf-v1', forwardVerified === 78, `verified=${forwardVerified}`);
