...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 61,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 9);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-61-forward-canonical-lf-v1', forwardVerified === 61, `verified=${forwardVerified}`);
