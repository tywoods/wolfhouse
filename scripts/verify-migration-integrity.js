...
pass(
  'green-forward-count',
  forwardEntries(manifest).length === 67,
...
// Non-forward classifications present
{
  ...
  pass('green-has-rollback', (byClass.rollback_down || 0) === 15);
...
// Slice 13A.1 — cross-platform checksum equivalence + fail-closed
{
  ...
  pass('green-all-67-forward-canonical-lf-v1', forwardVerified === 67, `verified=${forwardVerified}`);
