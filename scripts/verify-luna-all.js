...
const steps = [
  ...
  ['verify:luna-personality-contract', 'verify-luna-personality-contract.js'],
  ...
  ['verify:luna-personality-gateway-bind', 'verify-luna-personality-gateway-bind.js'],
  ...
  ['verify:luna-personality-radios', 'verify-luna-personality-radios.js'],
  ...
  ['verify:luna-same-desk-email-booking', 'verify-luna-same-desk-email-booking.js'],
