...
mkdir -p "$DATA_ORCH" "$DATA_LUNA" "$DATA_WOLFHOUSE_LUNA" "$DATA_SHARED"
...
chown -R 10000:10000 "$DATA_ORCH" "$DATA_LUNA" "$DATA_WOLFHOUSE_LUNA" "$DATA_SHARED"
...
touch /etc/hermes-orchestrator.env /etc/hermes-luna.env /etc/hermes-wolfhouse-luna.env
chmod 600 /etc/hermes-orchestrator.env /etc/hermes-luna.env /etc/hermes-wolfhouse-luna.env
...
echo "  2. Fill /etc/hermes-orchestrator.env, /etc/hermes-luna.env, and /etc/hermes-wolfhouse-luna.env"
