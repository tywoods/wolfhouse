...
DATA_WOLFHOUSE_LUNA="${DATA_WOLFHOUSE_LUNA:-/var/lib/hermes-wolfhouse-luna}"
DATA_DECKHAND="${DATA_DECKHAND:-/var/lib/hermes-deckhand}"
...
mkdir -p "$DATA_ORCH" "$DATA_LUNA" "$DATA_WOLFHOUSE_LUNA" "$DATA_DECKHAND" "$DATA_SHARED"
...
chown -R 10000:10000 "$DATA_ORCH" "$DATA_LUNA" "$DATA_WOLFHOUSE_LUNA" "$DATA_DECKHAND" "$DATA_SHARED"
...
touch /etc/hermes-orchestrator.env /etc/hermes-luna.env /etc/hermes-wolfhouse-luna.env /etc/hermes-deckhand.env
chmod 600 /etc/hermes-orchestrator.env /etc/hermes-luna.env /etc/hermes-wolfhouse-luna.env /etc/hermes-deckhand.env
...
echo "  2. Fill /etc/hermes-orchestrator.env, /etc/hermes-luna.env, /etc/hermes-wolfhouse-luna.env, and /etc/hermes-deckhand.env"
