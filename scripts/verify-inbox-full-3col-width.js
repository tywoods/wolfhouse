...
ok('3-col Full hidden uses the same 1634px cap',
  apiSrc.includes('.inbox-two-col.inbox-shell-cols[data-col1="full"][data-col2="comfortable"][data-col4="hidden"]{')
  && /\[data-col4="hidden"\]\{\s*max-width:1634px;margin-left:auto;margin-right:auto;--inbox-col4-w:300px;\s*\}/.test(apiSrc));
...
ok('Full hidden does not pull chat into the guest gap',
...
ok('columns gate asserts the 3-col cap',
...
ok('spec says Full hidden keeps 1634',
