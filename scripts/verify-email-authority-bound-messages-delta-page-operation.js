...
async function main() {
  ...
  // ── Closed-enum internal stage diagnostics (fail-site branding) ────────
  {
    const INTERNAL = Object.freeze([
      ...
      'store_page_commit_journal_claim_failed', 'store_delta_state_row_invalid',
      'store_cursor_commit_result_invalid', 'store_page_commit_journal_complete_failed',
    ...
    ok('internal-stages-are-thirty-distinct', distinct.size === 30);
  }
