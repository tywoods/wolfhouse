-- Stage 7.7k5 fixture seed — confirmed bed reassignment API proof
-- Booking WH-77K5-REASSIGN-001 assigned to the first active bed.
-- assignment_type is 'automatic' so the manual_operator_lock blocker does NOT fire.
-- Cleanup: scripts/fixtures/stage7.7k5-reassign-confirm-api-cleanup.sql
...
BEGIN
  ...
  INSERT INTO bookings (
    ...
    v_client_id, 'WH-77K5-REASSIGN-001', 'Fixture K5 Guest',
    '+34600000196', 'fixture-k5@example.com',
    1, 'SURF_7', '2026-11-03', '2026-11-10',
  ...
  INSERT INTO booking_beds (
    ...
    'automatic', 'Auto-assigned', 'WH-77K5-REASSIGN-001'
  );

  RAISE NOTICE 'Stage 7.7k5 fixture seeded: booking=%, bed=%/%', v_booking_id, v_room_code, v_bed_code;
END;
$$;
