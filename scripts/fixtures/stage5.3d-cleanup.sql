...
-- Scoped to wolfhouse-somo + fixture phone 34600000155 only.
...
-- SELECT COUNT(*) AS fixture_bookings   FROM bookings   WHERE phone IN ('34600000155', '+34600000155');
-- SELECT COUNT(*) AS fixture_payments   FROM payments   WHERE booking_id NOT IN (SELECT id FROM bookings WHERE phone IN ('34600000155','+34600000155'));
-- SELECT COUNT(*) AS fixture_convs      FROM conversations WHERE phone IN ('34600000155', '+34600000155');
