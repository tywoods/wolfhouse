...
check('M6', /stream_reply_to_patch|_wolfhouse_stream_reply_anchor/.test(patches), 'stream consumer Luna plain-reply patch');
check('M7', /stream_initial_reply_luna|STREAM_INITIAL_REPLY_NEW/.test(patches), 'gateway.run Luna stream initial_reply_to_id patch');
