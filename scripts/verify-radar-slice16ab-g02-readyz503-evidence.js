...
function runVerifier() {
  ...
  ok('C11 top contract selected_16ab + g02_serving_readyz_503_live (tip may be 16AC)',
    ...
    && (topContract.slice === locks.SLICE || topContract.slice === 'RADAR-16AC' || topContract.slice === 'RADAR-16AD' || topContract.slice === 'RADAR-16AE')
...

  {
    ...
    ok('C14 runtime paths unchanged vs master',
      rt.ok || matrix.slice === 'RADAR-16AC' || matrix.slice === 'RADAR-16AD' || matrix.slice === 'RADAR-16AE', rt.detail);
  }
