...
async function runVerifier() {
  ...
  ok('C1 HEAD on 16AH branch (or 16AI/16AJ tip)', currentBranch() === locks.BRANCH || tipBranchOk, currentBranch());
  ok('C2 master_basis locked (16AH lock or 16AI/16AJ tip)',
    ...
    || tipBasisOk);
  ok('C3 slice/outcome/branch locked (16AH lock or 16AI/16AJ tip)',
