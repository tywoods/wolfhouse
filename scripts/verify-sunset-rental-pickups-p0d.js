...
const pickups = dates.calendar(dates.weekdayFromNow('saturday', 30));
const DATE = pickups.day(0);
...
(async function ronnieCreatePath() {
  ...
  const DATE_R = pickups.day(21); // three Saturdays on from DATE
