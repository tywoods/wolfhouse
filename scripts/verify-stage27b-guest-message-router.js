...
const FIXTURES = [
  ...
  {
    id: 'F32',
    label: 'Stage 27test-p — Bilbao airport transfer',
    message: 'Transfer from Bilbao airport',
    expect: {
      lane: 'transfer_request',
      handoff: false,
      noBookingExtract: true,
      replyContains: ['Bilbao'],
    },
  },
  {
    id: 'F33',
    label: 'Stage 27test-p — Transfer von Bilbao',
    message: 'Transfer von Bilbao',
    expect: {
      lane: 'transfer_request',
      handoff: false,
      noBookingExtract: true,
  ...
  {
    id: 'F34',
    label: 'Stage 27test-p — Bilbao airport transfer phrase',
    message: 'Bilbao airport transfer',
    expect: {
      lane: 'transfer_request',
      handoff: false,
      noBookingExtract: true,
  ...
  {
    id: 'F35',
    label: 'Stage 27test-p — standalone date change question',
    message: 'Can I change my dates?',
    expect: {
      lane: 'cancel_or_change_request',
      handoff: false,
      noBookingExtract: true,
