...
assert('EN private lessons section', en.includes("'schedule.section.privateLessons': 'Private lessons'"));
assert('ES clases privadas section', es.includes("'schedule.section.privateLessons': 'Clases privadas'"));
