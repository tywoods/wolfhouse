...
if (routerOut.missing_required_fields && routerOut.missing_required_fields.includes('package_interest')) {
  pass('E3', 'asks for package when dates/guests known');
} else {
  fail('E3', `expected package_interest missing: ${JSON.stringify(routerOut.missing_required_fields)}`);
}
