...
assert.ok(EMAIL_LUNA_AUTOMATION_PRINCIPAL_CONTRACT.forbidden_databases.includes('sunset_staging'));
assert.ok(EMAIL_LUNA_AUTOMATION_PRINCIPAL_CONTRACT.forbidden_databases.includes('sunset_prod'));
assert.ok(EMAIL_LUNA_AUTOMATION_PRINCIPAL_CONTRACT.forbidden_databases.includes('wolfhouse_staging'));
