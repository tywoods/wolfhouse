...
`);
  ...
  green('g02_remains_partial',
    ...
    && matrix
    && (matrix.slice === locks.SLICE || matrix.slice === 'RADAR-16Z' || (matrix.slice === 'RADAR-16AA' || matrix.slice === 'RADAR-16AB' || matrix.slice === 'RADAR-16AC' || (matrix.slice === 'RADAR-16AD' || matrix.slice === 'RADAR-16AF')))
