...
const REQUIRED_RED = Object.freeze([
  ...
  'sigterm_propagates_original_signal_child',
  'sigint_propagates_original_signal_child',
  'child_process_sigterm_same_signal_during_cleanup',
  'child_process_sigint_same_signal_during_cleanup',
  'child_process_cleanup_once_under_repeated_signals',
  'listener_count_after_attach',
  'listener_count_stable_during_same_signal_redelivery',
  'listener_count_zero_after_cleanup',
  'module_reuse_no_listener_leak',
  'original_shutdown_signal_preserved_under_mixed_redelivery',
  'pool_close_awaited_before_server_close',
  'pool_close_awaited_before_terminate',
  'pool_close_rejected_bounded',
  'pool_close_throwing_bounded',
  'shutdown_logger_throw_bounded',
  'child_process_pool_close_throwing_bounded',
  'child_process_shutdown_logger_throw_bounded',
  'pool_close_never_settles_bounded',
  'server_close_rejected_bounded',
  'server_close_throwing_bounded',
  'server_close_callback_never_bounded',
  'server_close_already_closed_bounded',
  'server_close_after_pool_failure',
  'bounded_shutdown_completes',
  'concurrent_signals_idempotent',
  'concurrent_calls_share_promise',
  'listeners_removed_before_terminate',
  'factory_reuse_no_duplicate_listeners',
  'no_close_pg_pool_composition',
  'no_process_exit_zero',
...
const REQUIRED_GREEN = Object.freeze([
  ...
  'terminate_seam_present',
  'bounded_timers_unref',
  'failure_classification_bounded',
  'exception_cleanup_finally_terminates',
