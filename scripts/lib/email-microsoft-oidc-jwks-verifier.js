...
const ERROR_CODE = 'MICROSOFT_OIDC_JWKS_VERIFICATION_FAILED';
const ERROR_MESSAGE = 'Microsoft OIDC signature verification failed.';
...
function verificationFailure() {
  ...
  Object.defineProperty(error, 'name', {
    value: 'MicrosoftOidcJwksVerificationError',
  });
...
function selectJwk(body, expectedKid) {
  ...
  if (selected.kty !== 'RSA'
      || (selected.use !== undefined && selected.use !== 'sig')
