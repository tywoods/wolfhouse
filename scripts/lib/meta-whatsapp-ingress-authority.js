...
/**
 * FORTRESS Slice 15H2 — Meta WhatsApp ingress authority policy (B02).
 *
 ...
 * (`15H2_meta_ingress_authority_xact_lock`). Deferred 15G and deferred 15H
 * (session advisory lock) tips must not be merged; this module is the clean
 * replacement from master.
 */
...
/**
 * FORTRESS 15G2 / 15H2 — REPLAY_IDENTITY_COMPARE_REJECT_FILL.
