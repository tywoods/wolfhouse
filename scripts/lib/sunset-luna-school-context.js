...
function buildSunsetSchoolPromptHint(schoolContext) {
  ...
  return [
    ...
    'Lesson/course free gear: only claim inclusions from get_sunset_lesson_catalog / get_sunset_offering_quote fields (may_claim_free_equipment + free_included_equipment_labels / guest_equipment). Never invent wax/board/wetsuit.',
    ...
    'If the guest accepts, create with components.full_day_equipment_addon (structured), never notes-only.',
