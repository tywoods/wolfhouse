...
async function handleBotPaymentCreateStripeLink(paymentId, req, res, user, authMode, ctx) {
  ...
  // FORTRESS 15J / B15: nonempty boundClientSlug + scoped payment SELECT before Stripe/mutation.
  ...
  if (!tenantGate.ok) {
    ...
    // Uniform miss — do not disclose foreign-tenant payment existence/details.
