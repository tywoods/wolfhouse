...
const INTEGRATION_SOURCE_PROOF = Object.freeze({
  ...
  pass_rule:
    ...
    + 'hook once; no wrapper chains; module-private WeakSet fired sentinel '
    + 'marked before snapshot; symbols cleared after fire; reentrant/post-fire '
    + 'bind immediately safe-closes with already_fired result and no symbol '
    + 'reinstall; independent safe invoke of prior+owners with thenable '
    + 'rejection absorb and getter/call adversary catch); '
