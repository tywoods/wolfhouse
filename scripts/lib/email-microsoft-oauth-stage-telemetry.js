...
const STAGES = Object.freeze([
  ...
  'google_consume_started',
  'google_consume_returned',
  'google_consume_matched',
  'google_authority_started',
  'google_authority_returned',
  'google_authority_matched',
  'google_factory_started',
  'google_factory_returned',
  'google_provider_started',
  'google_provider_returned',
  'google_exchange_started',
  'google_exchange_returned',
  'phase_a_started',
  'phase_a_invalid',
  ...
  'token_response_envelope_validated',
  'token_response_json_validated',
  'token_response_fields_validated',
  'token_response_scope_rejected_invalid',
  'token_response_scope_rejected_duplicate',
  'token_response_scope_rejected_dangerous',
  'token_response_scope_rejected_phase_a_mixed',
  'token_response_scope_rejected_unknown',
  'token_response_scope_rejected_missing_required',
  'token_response_scope_validated',
