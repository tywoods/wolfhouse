...
module.exports = {
  ...
  'admin.lessonTimes.priceTitle': 'Precios de clases',
  'admin.lessonTimes.scheduleTitle': 'Horario de clases',
  ...
  'admin.capacity.futureNote': 'La capacidad se edita en cada tarjeta de clase.',
  'admin.capacity.help': 'Se usa cuando una clase no tiene capacidad propia.',
  ...
  'admin.lessonTimes.lessonsHelp': 'Horarios de clases sueltos para huéspedes y staff.',
  'admin.lessonTimes.lessonsTitle': 'Clases',
  'admin.section.packs': 'Cursos',
  'admin.packs.defaultName': 'Nuevo curso',
  'admin.packs.help': 'Cursos con playas, horarios, tamaño de grupo y precios.',
  'admin.packs.perStudent': '/ alumno',
  'admin.packs.placeholder': 'Aún no hay cursos configurados.',
  ...
  'admin.prices.group.lessons': 'Clases',
  ...
  'admin.lessonTimes.help': 'Gestiona los horarios que aparecen en Schedule y usa el equipo.',
  ...
  'admin.lessonTimes.capacitySchemaNote': 'Esta versión mejora el diseño y permite añadir/quitar clases. La capacidad por clase se muestra deshabilitada hasta tener un campo de capacidad por horario en DB.',
  ...
  'admin.section.lessonTimes': 'Packs y clases',
  ...
  'schedule.card.lessons': 'Clases',
  'schedule.card.lessonGroups': 'Grupos de clases',
  'schedule.card.courses': 'Cursos',
  'schedule.courses.unnamed': 'Curso',
  'schedule.courses.noneToday': 'Sin cursos hoy',
  'schedule.courses.noneConfigured': 'Sin cursos configurados',
