...
module.exports = {
  ...
  'schedule.drawer.otherItems': 'Otros artículos',
    'schedule.drawer.copyCode': 'Copiar código de reserva',
    'schedule.drawer.copy': 'Copiar',
  ...
  'schedule.view.week': 'Semana',
    ...
    'schedule.drawer.balanceDue': '{{amount}} pendiente',
    'schedule.drawer.paidInFull': 'Pagado por completo',
    'schedule.drawer.total': 'Total',
    'schedule.drawer.manualPayToggle': 'Registrar pago manual',
    'schedule.drawer.stripePrimaryCreate': 'Crear enlace de pago',
    'schedule.drawer.stripePrimaryCopy': 'Copiar enlace de pago',
    'schedule.drawer.stripePrimaryUpdate': 'Actualizar enlace de pago',
    'schedule.drawer.stripeLinkActive': 'Enlace de pago activo',
    'schedule.drawer.waiverSummaryProgress': '{{completed}} de {{target}} completados · {{status}}',
    'schedule.drawer.waiverSummaryDone': 'Completado',
    'schedule.drawer.waiverNoneShort': 'Sin crear',
    'schedule.drawer.waiverOpen': 'Abrir formulario',
