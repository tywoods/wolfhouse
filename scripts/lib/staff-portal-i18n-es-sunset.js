...
module.exports = {
  ...
  'schedule.view.week': 'Semana',
    ...
    'schedule.drawer.waiverExternalUnverified': 'Formulario externo (sin verificar)',
    'schedule.drawer.waiverExternalHint': 'Formulario de Google externo — la finalización no se verifica automáticamente.',
    'schedule.drawer.waiverDisabledOrMisconfigured': 'Los enlaces de formulario no están disponibles (desactivado o enlace inválido).',
    'schedule.drawer.waiverHistoricalNative': 'Existe un formulario nativo completado para esta reserva.',
