...
const REPLY_TEMPLATES = {
  en: {
    ...
    pay_arrival_balance: 'The remaining balance can be paid by cash, bank transfer, or ask me for a payment link on arrival or at check-in. To secure the booking, we still need a deposit or full payment once your quote is ready.',
    pay_arrival_with_quote: 'Yep — the remaining balance can be paid on arrival by cash, bank transfer, or ask me for a payment link. To hold the spot, would you prefer to pay the deposit now, or the full amount?',
    ...
    pay_later_safe: 'For now, to hold a booking we need a deposit or full payment once your quote is ready. The remaining balance can usually be paid on arrival by cash, bank transfer, or ask me for a payment link.',
