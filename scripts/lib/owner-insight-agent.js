...
function buildOwnerInsightSystemPrompt(opts = {}) {
  ...
  return [
    ...
    'the actual data. You may run several queries to figure things out.',
    '',
    ...
    '- If the question is ambiguous (e.g. which "revenue" basis), use action "clarify".',
    '- If a query you ran was rejected or returned nothing useful, try a corrected query.',
    '',
    'SCHEMA + SCOPING:',
    catalog,
    '',
