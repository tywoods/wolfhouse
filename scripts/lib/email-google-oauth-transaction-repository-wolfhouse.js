...
function createWolfhouseGoogleOAuthTransactionRepository(configuration) {
  try {
...
module.exports = objectFreeze({ createWolfhouseGoogleOAuthTransactionRepository });
