...
function buildOwnerSqlPlannerPrompt(opts = {}) {
  ...
  const system = [
    'You are the Owner Command Center SQL planner (Phase 25g).',
    ...
    '- Do not select raw_payload. Do not select metadata. Do not SELECT *.',
    '- If the request asks for raw/internal payloads or every column, return mode=unsupported.',
    ...
    '',
    'Example — safe guest message query (mode=sql):',
    'User: "List recent guest messages for Wolfhouse"',
    'SQL:',
