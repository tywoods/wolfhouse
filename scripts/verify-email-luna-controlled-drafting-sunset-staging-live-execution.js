...
async function main() {
  ...
  assert.match(cliSrc, /readerOwned\.closedAppFromArm/);
  assert.match(cliSrc, /readerOwned\.closedRevisionFromArm/);
  assert.doesNotMatch(cliSrc, /function closedAppFromArm/);
  assert.doesNotMatch(cliSrc, /function closedRevisionFromArm/);
  ...
  assert.match(fullSail, /Chapter 4J/);
  ...
  assert.match(fullSail, /luna-sunset-staging-staff-api--0000682/);
  assert.match(fullSail, /a4188eea71a92b7361818e024cde0f810d6ee018/);
  assert.match(fullSail, /sha256:820f302e8f59cfe8636eb0267c6f15bc0750f300b76735f511f3dde9c031dc39/);
  assert.match(fullSail, /reviewed candidate SHA\/tree after exact-head review and true merge/);
  assert.doesNotMatch(fullSail, /from a clean detached checkout at candidate `874bcde642d7eb4838529f84246c1c011db9861a`/);
  assert.doesNotMatch(fullSail, /live proof PASS/);
  assert.match(runbook, /Chapter 4I/);
  assert.match(runbook, /luna-sunset-staging-staff-api--0000682/);
  ...
  assert.match(ch4iDoc, /luna-sunset-staging-staff-api--0000682/);
  assert.match(ch4iDoc, /a4188eea71a92b7361818e024cde0f810d6ee018/);
  assert.match(ch4iDoc, /new reviewed candidate SHA\/tree after exact-head review and true merge/);
  assert.match(ch4iDoc, /not from `874bcde642d7eb4838529f84246c1c011db9861a`/);
