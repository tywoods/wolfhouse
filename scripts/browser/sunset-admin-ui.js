...
function renderAdminSectionAccommodationFromConfig(cfg){
  ...
  if (editing){
    ...
    html += '<label class="portal-admin-accommodation-bed-capacity"><span data-i18n="admin.accommodation.bedCapacity">' +
      escHtml(portalT('admin.accommodation.bedCapacity') || 'Bed capacity (Finance occupancy)') + '</span> ';
  ...
  root.addEventListener('click', function(ev){
    ...
    if (action === 'accom-add-range'){
      ...
      adminConfigCache.accommodation = {
        ...
        currency: 'EUR',
        bed_capacity: draft.bed_capacity != null ? draft.bed_capacity : null,
        ranges: curRanges,
    ...
    if (action === 'accom-remove-range'){
      ...
      adminConfigCache.accommodation = {
        ...
        currency: 'EUR',
        bed_capacity: draftRm.bed_capacity != null ? draftRm.bed_capacity : null,
        ranges: nextRanges,
