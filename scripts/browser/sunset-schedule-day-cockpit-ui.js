...
var SCHEDULE_DAY_COCKPIT_CSS = [
  ...
  '  .ck-bar{gap:8px;padding:10px 12px;align-items:center;}',
  '  .ck-bar__right{flex:1 1 100%;width:100%;margin-left:0;justify-content:flex-end;flex-wrap:nowrap;gap:8px;}',
