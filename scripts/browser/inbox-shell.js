...
function inboxMockupThemeCssText(){
  return [
    ...
    'font-size:18px;line-height:1;font-weight:700;cursor:pointer;opacity:0;',
    ...
    '#inbox-shell .conv-card-delete:focus-visible{opacity:1;color:#9C3D3D;background:rgba(156,61,61,.10);outline:none}',
    '#inbox-shell .conv-card-delete:focus-visible{box-shadow:0 0 0 2px rgba(156,61,61,.25)}',
    ...
    '}',
    '@media(max-width:768px){',
    '#inbox-shell .conv-card-delete{opacity:.72;width:44px;height:44px;min-width:44px;margin:-10px -8px -6px 4px;font-size:18px}',
