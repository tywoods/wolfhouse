...
function inboxMockupThemeCssText(){
  return [
    ...
    '#inbox-shell .inbox-header-stack-luna #btn-refresh{order:4}',
    ...
    '#tab-conversations .inbox-mobile-back,#inbox-shell .inbox-mobile-back{display:inline-flex;width:auto;min-height:28px;padding:2px 0;margin:0 0 4px;border:0;background:transparent;color:var(--text-2);font-size:13px;font-weight:500}',
    '#tab-conversations #inbox-shell.show-thread .inbox-header-stack{flex-direction:row;flex-wrap:wrap;align-items:center;justify-content:flex-start;gap:6px;width:100%}',
    '#tab-conversations #inbox-shell.show-thread .thread-messages{min-height:min(42vh,320px)!important}',
    '}',
