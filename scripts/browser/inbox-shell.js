...
function inboxMockupThemeCssText(){
  return [
    ...
    '#tab-conversations #inbox-shell.show-thread .inbox-thread-overflow{position:relative;display:inline-flex;align-items:center;flex:0 0 auto;margin-left:auto}',
    ...
    '#tab-conversations #inbox-shell.show-thread .inbox-thread-overflow-panel{display:none;flex-direction:column;align-items:stretch;gap:6px;position:absolute;right:0;top:calc(100% + 4px);z-index:70;min-width:min(240px,calc(100vw - 24px));padding:8px;box-sizing:border-box;background:var(--surface);border:1px solid var(--border-soft);border-radius:10px;box-shadow:var(--shadow-soft)}',
