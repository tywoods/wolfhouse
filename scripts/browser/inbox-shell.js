...
function inboxShellCssText(){
  return [
    ...
    '#tab-conversations #inbox-shell.inbox-two-col.inbox-shell-cols:not(.show-thread){grid-template-rows:auto auto auto auto!important;gap:12px;row-gap:12px}',
    ...
    '#tab-conversations #inbox-shell > .inbox-shell-channel-defaults.is-inbox-mobile-docked{width:100%;max-width:100%;box-sizing:border-box;margin:12px 0 0;align-self:stretch;order:4}',
    '#tab-conversations #inbox-shell > .inbox-col1{order:1;gap:12px}',
    '#tab-conversations #inbox-shell > #inbox-card{min-height:0;order:3;overflow:hidden}',
    '#tab-conversations #inbox-shell:not(.show-thread) > #inbox-card .inbox-left-rows{flex:0 0 auto;height:auto;overflow:visible}',
    '#tab-conversations #inbox-shell:not(.show-thread) > #inbox-card #conv-list.conv-list{padding-top:6px;padding-bottom:6px;box-sizing:border-box}',
    '}',
...
function inboxMockupThemeCssText(){
  return [
    ...
    '#inbox-shell.inbox-two-col.inbox-shell-cols{grid-template-columns:1fr!important;width:100%;max-width:100%;gap:12px;row-gap:12px}',
    ...
    'html[data-portal-client="sunset"] #inbox-shell.inbox-two-col.inbox-shell-cols.show-thread > .inbox-col1{display:flex!important;flex-direction:column;width:100%;padding:0;gap:12px;overflow:visible}',
    'html:not([data-portal-client]) #inbox-shell.inbox-two-col.inbox-shell-cols.show-thread > .inbox-col1{display:flex!important;flex-direction:column;width:100%;padding:0;gap:12px;overflow:visible}',
    'html[data-portal-client="sunset"] #inbox-shell.inbox-two-col.inbox-shell-cols.show-thread > .inbox-col1 > :not(.inbox-folder-tabs){display:none!important}',
    'html:not([data-portal-client]) #inbox-shell.inbox-two-col.inbox-shell-cols.show-thread > .inbox-col1 > :not(.inbox-folder-tabs){display:none!important}',
    ...
    /* Icon-only saved-view rail on phone (labels via aria-label/title). */
    '#inbox-shell .inbox-views-rail{flex-direction:row;flex-wrap:nowrap;align-items:center;justify-content:space-between;overflow-x:hidden;overflow-y:hidden;gap:4px;padding:6px 8px;max-width:100%;box-sizing:border-box}',
    '#inbox-shell .inbox-views-item{position:relative;flex:1 1 0;width:auto;min-width:0;max-width:56px;height:44px;min-height:44px;padding:0;justify-content:center;gap:0;border-radius:10px}',
    ...
    '#inbox-shell .inbox-views-item-count{position:absolute;top:4px;right:4px;min-width:14px;height:14px;padding:0 3px;border-radius:999px;font-size:9px;line-height:14px;text-align:center}',
    '#inbox-shell .inbox-views-item-ico{width:20px;height:20px}',
    '#inbox-shell .inbox-views-item-ico svg{width:20px;height:20px}',
    /* Phone detail header must grow — no Needs-human / Booking clip. */
    '#inbox-shell.inbox-two-col.show-thread .detail-header{flex-wrap:wrap;align-items:flex-start;gap:8px;padding:12px 14px;margin-bottom:12px;height:auto;max-height:none;overflow:visible}',
    '#inbox-shell.inbox-two-col.show-thread .detail-header-main{overflow:visible;min-height:min-content;flex:1 1 auto}',
    '#inbox-shell.inbox-two-col.show-thread .detail-header-main .detail-name,',
    '#inbox-shell.inbox-two-col.show-thread .detail-header-main .detail-meta{white-space:normal;overflow:visible;text-overflow:unset;word-break:break-word}',
    '}',
