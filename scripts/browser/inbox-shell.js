...
function inboxMockupThemeCssText(){
  return [
    ...
    '#tab-conversations #inbox-shell.show-thread .inbox-header-stack-luna > *,#tab-conversations #inbox-shell.show-thread .inbox-header-stack-luna #inbox-chat-chrome-slot,#tab-conversations #inbox-shell.show-thread .inbox-header-stack-luna #btn-inbox-spam,#tab-conversations #inbox-shell.show-thread .inbox-header-stack-luna #btn-inbox-clear-thread,#tab-conversations #inbox-shell.show-thread .inbox-header-stack-luna #btn-inbox-conv-delete{order:0!important}',
    ...
    /* SHARED-PHONE-INBOX-OVERFLOW-006 */
    '#tab-conversations #inbox-shell.show-thread .detail-header,#tab-conversations #inbox-shell.show-thread .inbox-header-stack-luna{overflow:visible!important}',
    '#tab-conversations #inbox-shell.show-thread .inbox-thread-overflow{position:relative;display:inline-flex;align-items:center;flex:0 0 auto;margin-left:auto;z-index:80}',
    ...
    '#tab-conversations #inbox-shell.show-thread .inbox-thread-overflow-panel{display:none;flex-direction:column;align-items:stretch;gap:6px;position:absolute;right:0;top:calc(100% + 4px);z-index:90;min-width:min(240px,calc(100vw - 24px));padding:8px;box-sizing:border-box;background:var(--surface);border:1px solid var(--border-soft);border-radius:10px;box-shadow:var(--shadow-soft)}',
    ...
    /* SHARED-PHONE-INBOX-HEADER-005 + THREAD-FILL-005 */
    '#tab-conversations #inbox-shell.show-thread .inbox-header-stack-channel #btn-refresh{width:28px;height:28px;min-width:28px;min-height:28px;padding:0;flex:0 0 auto;order:3}',
