...
var INBOX_ROWS_CSS = [
  ...
  'display:flex;flex-wrap:wrap!important;align-items:flex-start;gap:6px 8px;padding:4px 2px 6px;',
  'overflow-x:hidden!important;max-width:100%;box-sizing:border-box;',
  '}',
  '.inbox-two-col.show-thread .detail-header-main{flex:1 1 auto;min-width:0;order:1}',
  ...
  '.inbox-two-col.show-thread .detail-header-right{',
  'order:2;flex:1 1 100%;width:100%;max-width:100%;min-width:0;',
  'display:flex;flex-wrap:wrap!important;align-items:center;justify-content:flex-start;gap:6px;',
  'overflow-x:hidden!important;box-sizing:border-box;',
  '}',
  '.inbox-two-col.show-thread .inbox-header-stack{',
  'display:flex;flex-direction:row;flex-wrap:wrap!important;align-items:center;justify-content:flex-start;',
  'gap:6px;width:100%;max-width:100%;min-width:0;overflow-x:hidden!important;box-sizing:border-box;',
  '}',
  '.inbox-two-col.show-thread .inbox-header-stack-channel,',
  '.inbox-two-col.show-thread .inbox-header-stack-luna{',
  'display:flex;flex-direction:row;flex-wrap:wrap!important;align-items:center;justify-content:flex-start;gap:4px;',
  'flex:1 1 auto;min-width:0;max-width:100%;overflow-x:hidden!important;',
  '}',
