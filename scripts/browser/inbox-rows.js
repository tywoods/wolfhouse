...
var INBOX_ROWS_CSS = [
  ...
  'display:flex;flex-wrap:wrap;align-items:flex-start;gap:6px 8px;padding:4px 2px 6px;',
  '}',
  ...
  'gap:6px;width:100%;max-width:100%;min-width:0;overflow-x:hidden;box-sizing:border-box;',
  '}',
  '.inbox-two-col.show-thread .inbox-header-stack-channel,',
  '.inbox-two-col.show-thread .inbox-header-stack-luna{',
  'display:flex;flex-direction:row;flex-wrap:wrap;align-items:center;justify-content:flex-start;gap:4px;',
