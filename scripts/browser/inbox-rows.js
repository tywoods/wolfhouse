...
var INBOX_ROWS_CSS = [
  ...
  /* SUNSET-MOBILE-INBOX-PHONE-LAYOUT-002: compact conversation toolbar (not stacked full-width slabs). */
  '.inbox-two-col.show-thread .detail-header{',
  'display:grid!important;grid-template-columns:minmax(0,1fr) auto;grid-template-rows:auto auto;',
  'align-items:start;gap:6px 8px;padding:10px 14px!important;',
  'overflow-x:hidden!important;max-width:100%;box-sizing:border-box;',
  '}',
  '.inbox-two-col.show-thread .detail-header-main{grid-column:1;grid-row:1;min-width:0;order:unset}',
  '.inbox-two-col.show-thread .detail-header-pills{flex:0 0 auto;width:auto;margin-left:0!important;order:1;justify-content:flex-start;flex-wrap:wrap;gap:4px}',
  '.inbox-two-col.show-thread .detail-header-right{display:contents!important}',
  '.inbox-two-col.show-thread .inbox-header-stack{display:contents!important}',
  '.inbox-two-col.show-thread .inbox-header-stack-channel{',
  'grid-column:2;grid-row:1;display:flex!important;flex-direction:row;flex-wrap:nowrap;',
  'align-items:flex-start;justify-content:flex-end;gap:4px;overflow-x:hidden;',
  '}',
  '.inbox-two-col.show-thread .inbox-header-stack-luna{',
  'grid-column:1 / -1;grid-row:2;display:flex!important;flex-direction:row;flex-wrap:wrap!important;',
  'align-items:center;justify-content:flex-start;gap:4px;width:100%;max-width:100%;min-width:0;',
  'overflow-x:hidden!important;box-sizing:border-box;',
  '}',
  '.inbox-two-col.show-thread .inbox-composer-channel-btn{',
  ...
  '.inbox-two-col.show-thread .sidebar-expand-btn{display:none!important}',
  '.inbox-two-col.show-thread #inbox-header-luna-row > .inbox-mobile-back{',
  'display:inline-flex!important;width:28px!important;min-width:28px;height:28px;min-height:28px;',
  'padding:0;margin:0;border:1px solid var(--border-soft);border-radius:8px;align-items:center;justify-content:center;',
  '}',
  ...
  '}',
  '.inbox-two-col.show-thread .detail-main{',
  'flex:1 1 auto!important;min-height:0!important;overflow:hidden!important;',
  'display:flex!important;flex-direction:column!important;',
  '}',
  '.inbox-two-col.show-thread .thread-section,',
  '.inbox-two-col.show-thread .thread,',
  '.inbox-two-col.show-thread .inbox-thread-shell,',
  '.inbox-two-col.show-thread .inbox-thread-wrap{',
  'flex:1 1 auto!important;min-height:0!important;overflow:hidden!important;',
  ...
  '.inbox-two-col.show-thread .draft-actions > button{flex:1 1 0;min-width:0;min-height:36px;padding:6px 8px;font-size:11px}',
  '.inbox-two-col.show-thread #draft-textarea{min-height:40px!important;max-height:56px}',
  '.inbox-two-col.show-thread .inbox-mobile-back{width:max-content!important;align-self:flex-start;min-height:28px;padding:2px 0;background:transparent;border:0}',
  '}',
