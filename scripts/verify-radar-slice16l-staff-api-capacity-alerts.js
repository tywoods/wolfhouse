...
// Successor slices may own HEAD while 16L source remains frozen on its master basis.
const allowedBranches = new Set([
  BRANCH,
  'radar/slice-16m-stripe-event-claim',
  'radar/slice-16n-request-completion-log',
]);
ok('C4 branch pin (16L or successor 16M/16N)', allowedBranches.has(headBranch), headBranch);
