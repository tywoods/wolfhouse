'use strict';
/** Stage 28h.6 — deploy 5454799 fresh start reset. Temp — do not commit. */
const { execSync } = require('child_process');

const COMMIT = '5454799';
const IMAGE_TAG = `${COMMIT}-stage28h6-fresh-start-reset`;
const IMAGE = `whstagingacr.azurecr.io/wh-staff-api:${IMAGE_TAG}`;
const REV_SUFFIX = 's28h6-fresh-start-reset';
...
try {
  ...
  console.log(JSON.stringify({
    ...
    healthz: healthz(),
    image: IMAGE,
    fresh_start: 'POST /staff/conversations/:id/reset-luna-context',
    retest: ['Hello, I want to create a new booking please', 'July 1st to 5th. just me'],
  }, null, 2));
} catch (e) {
