...
def _sunset_tools():
    ...
    return [
        ...
        (
            ...
            "tell the guest you'll confirm with the team.",
            get_sunset_rental_price,
            {
                "item": {
                    "type": "string",
