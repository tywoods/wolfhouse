...
**Post-stabilization break-glass bookkeeping (availability/data-integrity; not a discretionary slice):** after PR #137 merged candidate `7870a9fb` into master `b9feab24`, detached-master C1 failed solely on branch name `HEAD` (110/1). Verifier remediation accepts original 16AP branch **or** descendant tips containing locked candidate `7870a9fb` as ancestor; unrelated detached tips lacking the candidate stay rejected. Score/evidence/gaps remain **0/9/0** unchanged.
