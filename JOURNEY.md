...
- **KNOWN OPEN:** Finance **Custom** date-range picker still dead live (failed 0461/0462); handed to **Skipper** for a proper live-page audit (the 19/19 verifier only tests a VM/DOM stub, not the served page). Awaiting Skipper handback → Captain deploy.
...
## 🚀 Live where
- **Sunset · staff-api** (staging) — `88c91f58` rev 0000463 · 08-04 03:30 · Captain _(cancel/hide v2: no Deleted, Hidden filter/tag, Refund-needed gating)_
